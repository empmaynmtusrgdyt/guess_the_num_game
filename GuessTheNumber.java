...
public class GuessTheNumber {
    public static void main(String[] args){
        ...
        while (YN) {
            System.out.println("Enter 1 to play as the number picker; enter 2 to play as the number guesser " +
            ...
            if (choose_a_mode == 1) {
                ...
                while (true) {
                    ...
                    if (MLE.equals("=")) {
                        System.out.println("I guessed your number! It was " + user_number);
                        break;
                    } else if (MLE.equals(">")) {
            ...
            YN = YNInput.equalsIgnoreCase("yes");
            }
        input.close();
        }
    }